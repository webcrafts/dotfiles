...
" EverVim
"-------------------------------------------------------------------------------
let g:evervim_devtoken='S=s239:U=1c589f3:E=149c0bf7ee2:C=142690e52e5:P=1cd:A=en-devtoken:V=2:H=a8ee57ffdf944cffef28019b9708e878'

"-------------------------------------------------------------------------------
" テンプレート補完
"-------------------------------------------------------------------------------
" 拡張子phpのファイルを作成した際に、.vim/template/php.txtテンプレートを読み込みます
...
"-------------------------------------------------------------------------------
" CSVH http://vim-users.jp/2009/09/hack78/
"-------------------------------------------------------------------------------
function! CSVH(x)
...
" vim-over ,+m
"-------------------------------------------------------------------------------
noremap <C-R> :OverCommandLine<CR>%s/
nnoremap <silent> <Leader>m :OverCommandLine<CR>%s/
let g:over_enable_cmd_window = 1
let g:over_command_line_prompt = "【置換する文字列を「/」の後に指定して「/文字/文字/」にする】---> "
"-------------------------------------------------------------------------------
" Yankround
"-------------------------------------------------------------------------------
